...
if (isset($_GET['id'])) {
	...
	$sql1 = "SELECT id_rawat FROM rawat WHERE id_rawat='$id'";
	...
	$sql2 = "DELETE FROM rawat WHERE id_rawat='$id'";
	$del = mysqli_query($db, $sql2) or die(mysqli_error($sql2));

	//jika query DELETE berhasil
	if ($del) {
		echo 'Data berhasil di hapus! ';		//Pesan jika proses hapus berhasil
		echo '<a href="tabel_rawat.php">Kembali</a>';	//membuat Link untuk kembali ke halaman tabel
	} else {
