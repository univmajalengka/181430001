...
if (isset($_GET['id'])) {
	...
	$sql1 = "SELECT id_perawat FROM perawat WHERE id_perawat='$id'";
	...
	$sql2 = "DELETE FROM perawat WHERE id_perawat='$id'";
	$del = mysqli_query($db, $sql2);

	//jika query DELETE berhasil
	if ($del) {
		echo 'Data berhasil di hapus! ';		//Pesan jika proses hapus berhasil
		echo '<a href="tabel_perawat.php">Kembali</a>';	//membuat Link untuk kembali ke halaman tabel
	} else {
