...
if (isset($_GET['id'])) {
	...
	$sql1 = "SELECT id_penyakit FROM penyakit WHERE id_penyakit='$id'";
	...
	$sql2 = "DELETE FROM penyakit WHERE id_penyakit='$id'";
	$del = mysqli_query($db, $sql2) or die(mysqli_error($sql1));

	//jika query DELETE berhasil
	if ($del) {
		echo 'Data berhasil di hapus! ';		//Pesan jika proses hapus berhasil
		echo '<a href="tabel_penyakit.php">Kembali</a>';	//membuat Link untuk kembali ke halaman tabel
	} else {
