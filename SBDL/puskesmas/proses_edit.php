<?php
    ...
    if(isset($_POST['simpan'])){
	    ...
	    $update = mysqli_query($db, $sql) or die(mysqli_error());
	    ...
	    if($update){
	    	...
	    	echo '<a href="edit_dokter.php?id_dokter='.$id_dokter.'">Kembali ke Edit</a>';	//membuat Link untuk kembali ke halaman edit
	    } 
    }
