			    ...
			    <tr>
				    ...
				    <td>
					    <select name="jenis_kelamin" required>
						    ...
						    <option value="L" <?php if($data['jenis_kelamin'] == 'L'){ echo 'selected'; } ?>>Laki-laki</option>	<!-- jika data di database sama dengan value maka akan terselect/terpilih -->
						    <option value="P" <?php if($data['jenis_kelamin'] == 'P'){ echo 'selected'; } ?>>Perempuan</option>	<!-- jika data di database sama dengan value maka akan terselect/terpilih -->
					    </select>
				    </td>
			    </tr>
                <tr>
